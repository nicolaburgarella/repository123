...
*/
public class CancelGroup extends JDialog {
	 ...
	 * @param hotel 
	 */
	public CancelGroup(Hotel hotel) {
		h=hotel;
		...
		{
			jLabel1 = new JLabel();
			jLabel1.setText("Cancello gruppo");
		}
		{
	...
	public void actionPerformed(ActionEvent e){
		 ...
		 if(e.getActionCommand().equals(jCheckBox2)){
			 //nome
		 ...
		 if(e.getActionCommand().equals(jCheckBox1)){
			 //id
